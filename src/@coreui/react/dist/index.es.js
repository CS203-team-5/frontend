...
var CNavGroup = forwardRef(function (_a, ref) {
    ...
    return (React__default.createElement("li", __assign({ className: _className }, rest, { ref: ref }),
        ...
        React__default.createElement(Transition$1, { in: _visible, timeout: 300, onEntering: onEntering, onEntered: onEntered, onExit: onExit, onExiting: onExiting, onExited: onExited }, function (state) { return (React__default.createElement("ul", { className: classNames('nav-group-items', {
                compact: compact,
