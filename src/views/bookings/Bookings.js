    ...
    render() {
        ...
        return (
            <div style={{ display: "table", margin: "auto" }}>
                {/* left div */}
                <div style={{ width: "751px", border: "1px solid red", float: "left", marginRight: "64px" }}>
                    <div >
                ...
                {/* right div */}
                <div style={{ border: "1px solid blue", textAlign: "center", float: "right", padding: "12px" }}>
                    <h1 >Date </h1>
                    {/* <Calendar date={moment("23/10/2015", "DD/MM/YYYY")} onSelect={this.onSelect} />  */}
                    <h4 style={{
                        height: "50px", width: "1", border: "",
                    }}>
