...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    Axios.get("http://18.140.56.69:8080/api/dailyForm/emp/date/users/week/" + yyyy + "-" + mm + "-" + dd, yourConfig).then(res => {

      setWeeklyUser(res.data);

    });

    Axios.get("http://18.140.56.69:8080/api/regulationLimit/emp/num/" + localStorage.getItem("username"), yourConfig).then(res => {
  ...
  const fetchQuota = async () => {
    ...
    var res = Axios.get("http://18.140.56.69:8080/api/bookings/emp/" + localStorage.getItem("username") + "/", yourConfig)
  ...
  const fetchCnaNewsRecord = async () => {
    const url = "http://18.140.56.69:8080/api/news/emp/cna/"
  ...
  const fetchCovidCasesRecord = async () => {
    const url = "http://18.140.56.69:8080/api/news/emp/covidcases/"
    const res = await fetch(url, yourConfig)
    // console.log(res)
    const data = await res.json()
    // console.log(data)
  ...
  const fetchVax = async () => {
    var res = ""
    res = await fetch("http://18.140.56.69:8080/api/user/emp/emailVax/" + localStorage.getItem("username") + "/", yourConfig)
    const data = await res.json()
    return data
  ...
  const fetchChecked = async () => {
    var res = ""
    res = await fetch("http://18.140.56.69:8080/api/dailyForm/emp/userToday/" + localStorage.getItem("username") + "/", yourConfig)
    const data = await res.json()
    return data
  }
