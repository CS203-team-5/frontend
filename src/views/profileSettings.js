   ...
   const handleFormSubmit = event => {
      ...
      const yourConfig = {
       ...
       if(oldFirstName!=firstName){
             ...
             axios.put("http://localhost:8080/api/user/update/fname/"+ firstName,
             user_object,
              yourConfig).then(res => { });

       }
       if(oldLastName!=lastName){
             axios.put("http://localhost:8080/api/user/update/lname/"+ lastName,
             user_object,
              yourConfig).then(res => { });
       ...
       if(oldEmail!=email){
              axios.put("http://localhost:8080/api/user/update/email/"+ email,
             user_object,
              yourConfig).then(res => { });
       }
